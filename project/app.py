...
def predict():
    ...
    User_ID = 0.0  # dummy, porque el modelo lo espera como primer feature
    ...
    # Vector EXACTO de 8 features
    X = np.array([[User_ID, sex_bin, age, height, weight, duration, heart_rate, temperature]],
                 dtype=np.float32)
